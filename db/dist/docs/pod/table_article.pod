...
=head1 FIELDS
 ...
 description (character varying) - The abstract of the article, or a similar brief description.
...
=head1 SCHEMA
 ...
 --------------------+-------------------+-----------+----------+--------------+-------------------------------------------------------------------------------
  ...
  description        | character varying |           | extended |              | The abstract of the article, or a similar brief description.
 Indexes:
