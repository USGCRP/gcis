...
=head1 FIELDS
 ...
 number (integer) - The numeric chapter number.
 ...
 description (character varying) - A brief description of the chapter.
...
=head1 SCHEMA
 ...
 -------------------+-------------------+-----------+----------+--------------+---------------------------------------------------
  ...
  number            | integer           |           | plain    |              | The numeric chapter number.
  ...
  description       | character varying |           | extended |              | A brief description of the chapter.
 Indexes:
