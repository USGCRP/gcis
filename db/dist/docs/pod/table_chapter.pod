...
=head1 SCHEMA
 ...
 Referenced by:
     TABLE "figure" CONSTRAINT "figure_chapter_report" FOREIGN KEY (chapter_identifier, report_identifier) REFERENCES chapter(identifier, report_identifier)
     TABLE "finding" CONSTRAINT "finding_chapter_report" FOREIGN KEY (chapter_identifier, report_identifier) REFERENCES chapter(identifier, report_identifier)
     TABLE ""table"" CONSTRAINT "table_chapter_identifier_fkey" FOREIGN KEY (chapter_identifier, report_identifier) REFERENCES chapter(identifier, report_identifier)
 Triggers:
