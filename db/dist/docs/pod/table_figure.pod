...
=head1 SCHEMA
 ...
 Referenced by:
     TABLE "image_figure_map" CONSTRAINT "image_figure_map_figure_fkey" FOREIGN KEY (figure, report) REFERENCES figure(identifier, report) ON DELETE CASCADE
 Triggers:
