...
=head1 SCHEMA
 ...
 Foreign-key constraints:
     "figure_chapter_report" FOREIGN KEY (chapter_identifier, report_identifier) REFERENCES chapter(identifier, report_identifier)
     "figure_report_fkey" FOREIGN KEY (report_identifier) REFERENCES report(identifier)
 Referenced by:
