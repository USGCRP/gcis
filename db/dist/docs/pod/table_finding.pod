...
=head1 FIELDS
 ...
 ordinal (integer) - The numeric position of this finding with a chapter (or report).
...
=head1 SCHEMA
 ...
 --------------------+-------------------+-----------+----------+--------------+------------------------------------------------------------------------
  ...
  ordinal            | integer           |           | plain    |              | The numeric position of this finding with a chapter (or report).
