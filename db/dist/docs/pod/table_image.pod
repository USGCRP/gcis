...
=head1 SCHEMA
 ...
 Referenced by:
     TABLE "file" CONSTRAINT "file_image" FOREIGN KEY (image) REFERENCES image(identifier) ON DELETE CASCADE
     TABLE "image_figure_map" CONSTRAINT "image_figure_map_image_fkey" FOREIGN KEY (image) REFERENCES image(identifier) ON DELETE CASCADE
 Triggers:
