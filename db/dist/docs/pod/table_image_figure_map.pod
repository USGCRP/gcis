...
A figure can have many images and vice versa.

=head1 FIELDS

 image_identifier (character varying) - The image.
 figure_identifier (character varying) - The figure.
 report_identifier (character varying) - The report containing the figure.
...
=head1 SCHEMA
 ...
 -------------------+-------------------+-----------+----------+--------------+-----------------------------------
  image_identifier  | character varying | not null  | extended |              | The image.
  figure_identifier | character varying | not null  | extended |              | The figure.
  report_identifier | character varying | not null  | extended |              | The report containing the figure.
 Indexes:
