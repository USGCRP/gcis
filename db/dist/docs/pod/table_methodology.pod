...
A methodology is a publication associated with an activity

=head1 FIELDS

 activity_identifier (character varying) - The activity.
...
=head1 SCHEMA
 ...
 ---------------------+-------------------+-----------+----------+--------------+------------------
  activity_identifier | character varying | not null  | extended |              | The activity.
