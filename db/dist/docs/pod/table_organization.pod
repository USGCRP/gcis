...
=head1 SCHEMA
 ...
 Referenced by:
     ...
     TABLE "organization_alternate_name" CONSTRAINT "organization_alternate_name_organization_identifier_fkey" FOREIGN KEY (organization_identifier) REFERENCES organization(identifier) ON DELETE CASCADE
