...
=head1 SCHEMA
 ...
 Indexes:
     "organization_alternate_name_pkey" PRIMARY KEY, btree (organization_identifier, alternate_name)
 Check constraints:
     "iso_lang_length" CHECK (char_length(language::text) >= 2)
 Foreign-key constraints:
     "organization_alternate_name_organization_identifier_fkey" FOREIGN KEY (organization_identifier) REFERENCES organization(identifier) ON DELETE CASCADE
 Has OIDs: no
