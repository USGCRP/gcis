...
=head1 SCHEMA
 ...
 Referenced by:
     TABLE "organization_type_map" CONSTRAINT "organization_type_map_organization_type_fkey" FOREIGN KEY (organization_type) REFERENCES organization_type(identifier) ON DELETE CASCADE
 Triggers:
