...
=head1 FIELDS
 ...
 publication_id (integer) - The publication in which this reference appears.
...
=head1 SCHEMA
 ...
 ----------------------+-------------------+-----------+----------+--------------+--------------------------------------------------
  ...
  publication_id       | integer           | not null  | plain    |              | The publication in which this reference appears.
 ...
 Check constraints:
     ...
     "no_self_references" CHECK (child_publication_id <> publication_id)
