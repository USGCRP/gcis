...
=head1 SCHEMA
 ...
 Referenced by:
     TABLE "array_table_map" CONSTRAINT "array_table_map_table_identifier_fkey" FOREIGN KEY (table_identifier, report_identifier) REFERENCES "table"(identifier, report_identifier)
 Triggers:
