...
update role_type set sort_key=30 where identifier = 'contributing_author';
update role_type set sort_key=40 where identifier = 'author';
update role_type set sort_key=50 where identifier = 'principal_author';
update role_type set sort_key=60 where identifier = 'primary_author';
update role_type set sort_key=70 where identifier = 'secondary_author';
